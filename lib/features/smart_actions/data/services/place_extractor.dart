...
abstract class PlaceExtractor {
  ...
  static final RegExp _strongLabel = RegExp(
    ...
    'عنوان التوصيل|عنوان الشحن|عنوان المنزل|مكان الاستلام|'
  ...
  static final RegExp _weakLabel = RegExp(
    ...
    'العنوان|عنوان|الموقع|موقع|المكان|'
    'adresse|emplacement|dirección|ubicación)'
    '$_gap$_colon$_gap'
    r'([^\n]{6,90})',
    caseSensitive: false,
  );
  ...
  /// The Arabic form is the mirror image: the kind-of-road word comes first
  /// and the name follows it.
  static final RegExp _streetLineArabic = RegExp(
    '(?:شارع|طريق|حي|حى|جاده|جادة|ميدان|دوار)[  ]+[^\\n,،]{2,40}',
  );
