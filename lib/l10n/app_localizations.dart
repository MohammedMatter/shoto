...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Filing that happens without you'**
  String get rulesSubtitle;

  /// No description provided for @rulesTeachHeadline.
  ///
  /// In en, this message translates to:
  /// **'Stop sorting screenshots by hand'**
  String get rulesTeachHeadline;

  /// No description provided for @rulesTeachIntro.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulesTeachExample.
  ///
  /// In en, this message translates to:
  /// **'For example: when a screenshot contains a card number → file it in Receipts.'**
  String get rulesTeachExample;

  /// No description provided for @rulesTeachStep1Title.
  ///
  /// In en, this message translates to:
  /// **'1. Describe the screenshot'**
  String get rulesTeachStep1Title;

  /// No description provided for @rulesTeachStep1Body.
  ///
  /// In en, this message translates to:
  /// **'A word printed in it, something it shows, or private data inside it.'**
  String get rulesTeachStep1Body;

  /// No description provided for @rulesTeachStep2Title.
  ///
  /// In en, this message translates to:
  /// **'2. Choose the folder'**
  String get rulesTeachStep2Title;

  /// No description provided for @rulesTeachStep2Body.
  ///
  /// In en, this message translates to:
  /// **'Where matching screenshots should end up.'**
  String get rulesTeachStep2Body;

  /// No description provided for @rulesTeachStep3Title.
  ///
  /// In en, this message translates to:
  /// **'3. That is all'**
  String get rulesTeachStep3Title;

  /// No description provided for @rulesTeachStep3Body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulesTeachShow.
  ///
  /// In en, this message translates to:
  /// **'How do rules work?'**
  String get rulesTeachShow;

  /// No description provided for @rulesTeachHide.
  ///
  /// In en, this message translates to:
  /// **'Got it'**
  String get rulesTeachHide;

  /// No description provided for @rulesStartTemplates.
  ///
  /// In en, this message translates to:
  /// **'Or start from an example'**
  String get rulesStartTemplates;

  /// No description provided for @rulesTemplateReceipts.
  ///
  /// In en, this message translates to:
  /// **'Receipts & bills'**
  String get rulesTemplateReceipts;

  /// No description provided for @rulesTemplateReceiptsWhy.
  ///
  /// In en, this message translates to:
  /// **'Anything with a card number or a total on it'**
  String get rulesTemplateReceiptsWhy;

  /// No description provided for @rulesTemplateTickets.
  ///
  /// In en, this message translates to:
  /// **'Tickets & bookings'**
  String get rulesTemplateTickets;

  /// No description provided for @rulesTemplateTicketsWhy.
  ///
  /// In en, this message translates to:
  /// **'Boarding passes, reservations, order confirmations'**
  String get rulesTemplateTicketsWhy;

  /// No description provided for @rulesTemplateCodes.
  ///
  /// In en, this message translates to:
  /// **'Codes & passwords'**
  String get rulesTemplateCodes;

  /// No description provided for @rulesTemplateCodesWhy.
  ///
  /// In en, this message translates to:
  /// **'One-time codes and anything that looks like a password'**
  String get rulesTemplateCodesWhy;

  /// No description provided for @rulesTemplateAnimals.
  ///
  /// In en, this message translates to:
  /// **'Photos of animals'**
  String get rulesTemplateAnimals;

  /// No description provided for @rulesTemplateAnimalsWhy.
  ///
  /// In en, this message translates to:
  /// **'Uses what the picture shows, not the words in it'**
  String get rulesTemplateAnimalsWhy;

  /// No description provided for @rulesTemplatePicked.
  ///
  /// In en, this message translates to:
  /// **'Pick a folder and it is ready to save.'**
  ...
  /// No description provided for @rulesNeedFolderFirst.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulesDeleteMessage.
  ///
  /// In en, this message translates to:
  /// **'Screenshots it already filed stay where they are.'**
  String get rulesDeleteMessage;

  /// No description provided for @rulesWhenIt.
  ///
  /// In en, this message translates to:
  /// **'When it {summary}'**
  String rulesWhenIt(String summary);

  /// No description provided for @rulesBacklogTitle.
  ///
  /// In en, this message translates to:
  /// **'Catch up on the backlog'**
  String get rulesBacklogTitle;

  /// No description provided for @rulesBacklogIdle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulesBacklogRunning.
  ///
  /// In en, this message translates to:
  /// **'Checking {done} of {total}…'**
  String rulesBacklogRunning(int done, int total);

  /// No description provided for @rulesBacklogNothing.
  ///
  /// In en, this message translates to:
  /// **'Nothing left unsorted.'**
  String get rulesBacklogNothing;

  /// No description provided for @rulesBacklogResult.
  ///
  /// In en, this message translates to:
  /// **'Filed {filed} of {examined} unsorted screenshots.'**
  String rulesBacklogResult(int filed, int examined);

  /// No description provided for @rulesRunNow.
  ///
  /// In en, this message translates to:
  /// **'Run rules now'**
  String get rulesRunNow;

  /// No description provided for @ruleBuilderTitle.
  ///
  /// In en, this message translates to:
  /// **'New rule'**
  String get ruleBuilderTitle;

  /// No description provided for @ruleBuilderIntro.
  ///
  /// In en, this message translates to:
  /// **'Two questions: what it matches, and where it goes.'**
  String get ruleBuilderIntro;

  /// No description provided for @ruleBuilderFolderLabel.
  ///
  /// In en, this message translates to:
  /// **'Where does it go?'**
  String get ruleBuilderFolderLabel;

  /// No description provided for @ruleBuilderConditionLabel.
  ///
  /// In en, this message translates to:
  /// **'What should it match?'**
  String get ruleBuilderConditionLabel;

  /// No description provided for @ruleBuilderConditionsLabel.
  ///
  /// In en, this message translates to:
  /// **'Also matching'**
  String get ruleBuilderConditionsLabel;

  /// No description provided for @ruleBuilderAddCondition.
  ///
  /// In en, this message translates to:
  /// **'Add another'**
  String get ruleBuilderAddCondition;

  /// No description provided for @ruleBuilderMatchAll.
  ///
  /// In en, this message translates to:
  /// **'All of them'**
  String get ruleBuilderMatchAll;

  /// No description provided for @ruleBuilderMatchAny.
  ///
  /// In en, this message translates to:
  /// **'Any one'**
  String get ruleBuilderMatchAny;

  /// No description provided for @ruleBuilderMatchAllHelp.
  ///
  /// In en, this message translates to:
  /// **'The screenshot has to satisfy every one of these.'**
  String get ruleBuilderMatchAllHelp;

  /// No description provided for @ruleBuilderMatchAnyHelp.
  ///
  /// In en, this message translates to:
  /// **'One of these being true is enough.'**
  String get ruleBuilderMatchAnyHelp;

  /// No description provided for @ruleBuilderSave.
  ///
  /// In en, this message translates to:
  /// **'Save rule'**
  String get ruleBuilderSave;

  /// No description provided for @ruleBuilderIncomplete.
  ///
  /// In en, this message translates to:
  /// **'Pick what to match, and a folder'**
  String get ruleBuilderIncomplete;

  /// No description provided for @ruleBuilderPreview.
  ///
  /// In en, this message translates to:
  /// **'File into {folder} when the screenshot {summary}.'**
  String ruleBuilderPreview(String folder, String summary);

  /// No description provided for @ruleBuilderPreviewTitle.
  ///
  /// In en, this message translates to:
  /// **'YOUR RULE, IN WORDS'**
  String get ruleBuilderPreviewTitle;

  /// No description provided for @conditionTextContains.
  ///
  /// In en, this message translates to:
  /// **'says a word'**
  String get conditionTextContains;

  /// No description provided for @conditionTextContainsHelp.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @conditionTextContainsHint.
  ///
  /// In en, this message translates to:
  /// **'a word printed in it — \"invoice\", \"ticket\"'**
  String get conditionTextContainsHint;

  /// No description provided for @conditionShowsSubject.
  ///
  /// In en, this message translates to:
  /// **'shows something'**
  String get conditionShowsSubject;

  /// No description provided for @conditionShowsSubjectHelp.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @conditionShowsSubjectHint.
  ///
  /// In en, this message translates to:
  /// **'what it shows — \"cat\", \"animal\", \"food\"'**
  String get conditionShowsSubjectHint;

  /// No description provided for @conditionContainsSensitive.
  ///
  /// In en, this message translates to:
  /// **'contains private data'**
  String get conditionContainsSensitive;

  /// No description provided for @conditionContainsSensitiveHelp.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @conditionHasAnyText.
  ///
  /// In en, this message translates to:
  /// **'has readable text'**
  String get conditionHasAnyText;

  /// No description provided for @conditionHasAnyTextHelp.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @settingsAutomationCaption.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @quickSaveFiledByRules.
  ///
  /// In en, this message translates to:
  /// **'Filed by your rules.'**
  String get quickSaveFiledByRules;

  /// No description provided for @quickSaveNoRuleMatched.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @ruleSummaryEmpty.
  ///
  /// In en, this message translates to:
  /// **'No conditions yet — files nothing'**
  String get ruleSummaryEmpty;

  /// No description provided for @ruleJoinAnd.
  ///
  /// In en, this message translates to:
  /// **' and '**
  String get ruleJoinAnd;

  /// No description provided for @ruleJoinOr.
  ///
  /// In en, this message translates to:
  /// **' or '**
  String get ruleJoinOr;

  /// No description provided for @ruleSaysWord.
  ///
  /// In en, this message translates to:
  /// **'says \"{value}\"'**
  String ruleSaysWord(String value);

  /// No description provided for @ruleNotSaysWord.
  ///
  /// In en, this message translates to:
  /// **'does not say \"{value}\"'**
  String ruleNotSaysWord(String value);

  /// No description provided for @ruleShows.
  ///
  /// In en, this message translates to:
  /// **'shows {value}'**
  String ruleShows(String value);

  /// No description provided for @ruleNotShows.
  ///
  /// In en, this message translates to:
  /// **'does not show {value}'**
  String ruleNotShows(String value);

  /// No description provided for @ruleContains.
  ///
  /// In en, this message translates to:
  /// **'contains {value}'**
  String ruleContains(String value);

  /// No description provided for @ruleNotContains.
  ///
  /// In en, this message translates to:
  /// **'does not contain {value}'**
  String ruleNotContains(String value);

  /// No description provided for @ruleHasText.
  ///
  /// In en, this message translates to:
  /// **'has readable text'**
  String get ruleHasText;

  /// No description provided for @ruleNoText.
  ///
  /// In en, this message translates to:
  /// **'has no readable text'**
  String get ruleNoText;
  ...
  /// No description provided for @errorLoadRules.
  ///
  /// In en, this message translates to:
  /// **'Could not load your rules.'**
  String get errorLoadRules;
  ...
  /// No description provided for @quickSaveByRules.
  ///
  /// In en, this message translates to:
  /// **'Let my rules file it'**
  String get quickSaveByRules;

  /// No description provided for @ruleSeenTitle.
  ///
  /// In en, this message translates to:
  /// **'WHAT SHOTO HAS SEEN IN YOUR LIBRARY'**
  String get ruleSeenTitle;

  /// No description provided for @ruleSeenEmpty.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @ruleSeenHint.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulePreviewMatches.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Would take 1 of the {indexed} screenshots SHOTO has read} other{Would take {count} of the {indexed} screenshots SHOTO has read}}'**
  String rulePreviewMatches(int count, int indexed);

  /// No description provided for @rulePreviewNone.
  ///
  /// In en, this message translates to:
  /// **'Nothing SHOTO has read so far matches this'**
  String get rulePreviewNone;

  /// No description provided for @rulePreviewNotIndexed.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulePreviewTaken.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 of these goes to a rule above this one instead.} other{{count} of these go to a rule above this one instead.}}'**
  String rulePreviewTaken(int count);

  /// No description provided for @rulePreviewAllTaken.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulePreviewFloor.
  ///
  /// In en, this message translates to:
  /// **'Counts only what SHOTO has read so far. New screenshots are checked as they arrive.'**
  String get rulePreviewFloor;

  /// No description provided for @ruleBuilderEditTitle.
  ///
  /// In en, this message translates to:
  /// **'Edit rule'**
  String get ruleBuilderEditTitle;

  /// No description provided for @ruleBuilderEditIntro.
  ///
  /// In en, this message translates to:
  /// **'Changes apply from now on. Screenshots this rule already filed stay where they are.'**
  String get ruleBuilderEditIntro;

  /// No description provided for @ruleBuilderUpdate.
  ///
  /// In en, this message translates to:
  /// **'Save changes'**
  String get ruleBuilderUpdate;

  /// No description provided for @rulesPriorityNote.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rulesCardNotIndexed.
  ///
  /// In en, this message translates to:
  /// **'Nothing read yet — nothing to check this against'**
  String get rulesCardNotIndexed;

  /// No description provided for @rulesCardClaims.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Claims 1 screenshot} other{Claims {count} screenshots}}'**
  String rulesCardClaims(int count);

  /// No description provided for @rulesCardClaimsNone.
  ///
  /// In en, this message translates to:
  /// **'Claims nothing yet'**
  String get rulesCardClaimsNone;

  /// No description provided for @rulesCardOverruled.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 match goes to a rule above this one} other{{count} matches go to a rule above this one}}'**
  ...
  /// No description provided for @rulesBacklogUnread.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 screenshot has not been read yet — run again to continue.} other{{count} screenshots have not been read yet — run again to continue.}}'**
  String rulesBacklogUnread(int count);

  /// No description provided for @indexingProgress.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Still reading your screenshots — 1 to go} other{Still reading your screenshots — {count} to go}}'**
  String indexingProgress(int count);

  /// No description provided for @ruleBuilderMatches.
  ///
  /// In en, this message translates to:
  /// **'Matches'**
  String get ruleBuilderMatches;

  /// No description provided for @ruleBuilderMatchesNot.
  ///
  /// In en, this message translates to:
  /// **'Does NOT match'**
  String get ruleBuilderMatchesNot;

  /// No description provided for @ruleBuilderMatchesNotHelp.
  ///
  /// In en, this message translates to:
  /// **'The rule fires when this is false — use it to carve out an exception.'**
  String get ruleBuilderMatchesNotHelp;

  /// No description provided for @rulePreviewAlreadyFiled.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 of these is already in a folder, and a run never moves those. Only new screenshots will be filed here.} other{{count} of these are already in folders, and a run never moves those. Only new screenshots will be filed here.}}'**
  String rulePreviewAlreadyFiled(int count);

  /// No description provided for @rulesCardAlreadyFiled.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{Matches 1, but it is already filed elsewhere} other{Matches {count}, but they are already filed elsewhere}}'**
