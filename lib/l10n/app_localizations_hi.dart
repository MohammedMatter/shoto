...
class AppLocalizationsHi extends AppLocalizations {
  ...
  String get authSubtitle =>
      'साइन इन करने से फ़ोन बदलने पर आपकी सदस्यता आपके साथ रहती है। आपके स्क्रीनशॉट वैसे भी इसी डिवाइस पर रहते हैं — खाता उन्हें कभी नहीं ले जाता।';
  ...
  String paywallTrialCta(int days) {
    String _temp0 = intl.Intl.pluralLogic(
      days,
      locale: localeName,
      other: '$days दिन मुफ़्त शुरू करें',
      one: '1 दिन मुफ़्त शुरू करें',
    );
    return '$_temp0';
  }
  ...
  String paywallTrialNote(int days, String price) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$days दिन मुफ़्त, फिर $price। खत्म होने से पहले कभी भी रद्द करें।',
      one: 'एक दिन मुफ़्त, फिर $price। खत्म होने से पहले कभी भी रद्द करें।',
    );
    return '$_temp0';
  }

  @override
  String get triageTitle => 'पिछली बार के बाद';

  @override
  String get triageBody =>
      'जो SHOTO में रखना है वही रखिए। बाकी सब जहाँ है वहीं रहेगा।';

  @override
  String get triageKeep => 'रखें';

  @override
  String get triageSkip => 'छोड़ें';

  @override
  String get triageFinish => 'हो गया';
  ...
  String triageNewCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count नए स्क्रीनशॉट',
      one: '1 नया स्क्रीनशॉट',
    );
    return '$_temp0';
  }
  ...
  @override
  String get settingsTriage => 'नए स्क्रीनशॉट दिखाएँ';
  ...
  String get settingsPrivacyNote =>
      'SHOTO सिर्फ़ वही स्क्रीनशॉट रखता है जो आप इसे देते हैं, और उनके साथ जो कुछ करता है — पाठ पढ़ना, डुप्लिकेट ढूँढना — सब इसी डिवाइस पर होता है। आपकी तस्वीरें कभी अपलोड नहीं होतीं। तीन चीज़ें आप ख़ुद चालू करते हैं: नए स्क्रीनशॉट दिखाना आपका स्क्रीनशॉट एल्बम पढ़ता है ताकि उनके बारे में पूछ सके, खाता सिर्फ़ आपका ईमेल भेजता है ताकि फ़ोन बदलने पर सदस्यता बनी रहे, और क्रैश रिपोर्ट भेजती है कि क्या टूटा — कोड, कभी कोई तस्वीर नहीं।';
  ...
  @override
  String get libraryShowEverything => 'सब कुछ';
